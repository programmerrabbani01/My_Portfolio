            ...
            >
              <div className=" flex flex-1 xl:gap-x-6 ">
                ...
                <div className=" relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0 ">
                  <div className=" text-2xl xl:text-4xl font-extrabold text-indigo-400 mb-2 ">
              ...
              {aboutData.map((item, indexItem) => {
                return (
                  <div
                    ...
                    className={`${
                      index === indexItem &&
                      "text-indigo-400 after:w-[100%] after:bg-indigo-500 after:transition-all after:duration-300 "
