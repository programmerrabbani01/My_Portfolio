        ...
        {serviceData.map((item, index) => {
          return (
            <SwiperSlide key={index}>
              ...
              >
                {/* icons */}
                <div className=" text-4xl text-indigo-400 mb-4 ">{item.icon}</div>
                {/* title & desc */}
                <div className="mb-8">
                ...
                <div className=" text-3xl ">
                  <RxArrowTopRight className=" group-hover:rotate-45 group-hover:text-indigo-400 transition-all duration-300 " />
                </div>
              </div>
            </SwiperSlide>
          );
